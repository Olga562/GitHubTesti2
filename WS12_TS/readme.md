...
1. # **Configure and test TypeScript in VSC**
...
1. # **Building a web page with TypeScript**
...
1. Inside the **src** folder, create an **app.ts** file:
...
1. Run the following command to compile your TypeScript code:

*tsc* 

1. This will generate a **dist** folder with the compiled JavaScript file (**app.js**).
